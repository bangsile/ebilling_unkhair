<div>
  ...
  <div class="flex justify-between py-7">
    <button onclick="location.href='{{ route('billing.dosen.tambah') }}'" class="bg-sky-500 inline-block py-2 px-3 rounded-md text-white">
      Tambah Billing
    </button>
    <div>
    ...
    <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
      <thead class="ltr:text-left rtl:text-right">
        <tr>
          ...
          <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-start">Nama Kegiatan</th>
          <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-start">Tgl. Kegiatan</th>
      ...
      <tbody class="divide-y divide-gray-200">
        @foreach ($billings as $index => $billing)
          <tr class="odd:bg-gray-50">
            ...
            @endphp
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $detail->nama_kegiatan ?? '-' }}</td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">
              {{ $detail->tgl_kegiatan ? date('d-m-Y', strtotime($detail->tgl_kegiatan)) : '-' }}</td>
        ...
        @endforeach
        {{-- <tr class="odd:bg-gray-50">
            <td class="whitespace-nowrap px-4 py-2  text-gray-700">1234567890</td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">0987654321</td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">BNI</td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">Fee</td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">Rp120.000</td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">12/12/2024</td>
            <td class="whitespace-nowrap px-4 py-2 text-gray-700">
              <div class="inline-block px-4 py-1.5 bg-yellow-300 rounded-md font-semibold ext-white">
                Pending
              </div>
