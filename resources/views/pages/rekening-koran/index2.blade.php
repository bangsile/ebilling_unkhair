                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <fieldset class="border p-2 mb-3 shadow-sm">
                                ...
                                <form class="form-horizontal ml-2">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" name="jenisbayar" style="width: 100%;"
                                                ...
                                                <optgroup label="E-Billing Mahasiswa">
                                                    @foreach ($jenisbayara as $row)
                                                        @if (in_array($row->kode, ['ukt', 'umb', 'ipi', 'pemkes']))
                                                            <option
                                                                value="{{ route('rekeningkoran.pilih-jenisbayar', $row->kode) }}"
                                                ...
                                                <optgroup label="Manajemen E-Billing">
                                                    @foreach ($jenisbayara as $row)
                                                        @if (in_array($row->kode, ['pmb', 'pmb-pasca', 'ppg']))
                                                            <option
                                                                value="{{ route('rekeningkoran.pilih-jenisbayar', $row->kode) }}"
                                                                {{ request()->jenisbayar == $row->kode ? 'selected' : '' }}>
                                                                {{ $row->keterangan }} ({{ $row->bank }})
                                            ...
                                            <input type="hidden" value="{{ $jb_selected }}" id="jenisbayar">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">
                            ...
                            @if (in_array($jb_selected, ['ukt', 'umb', 'ipi', 'pemkes']))
                            ...
                            @if (in_array($jb_selected, ['pmb', 'pmb-pasca', 'ppg']))
                                <div class="table-responsive">
                                    <table id="{{ $datatable['id_table'] }}" class="table table-sm table-bordered"
                                        style="width:100%; font-size:12px;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-left" style="width: 10%">Trx ID</th>
                                                <th class="text-left" style="width: 10%">VA</th>
                                                <th class="text-left" style="width: 5%">Bank</th>
                                                <th class="text-left" style="width: 10%">Nominal</th>
                                                <th class="text-left" style="width: 20%">Nama Lengkap</th>
            ...
            <script type="text/javascript">
                ...
                function aktif_tautan() {
                    ...
                    if (params && jenisbayar) {
                        var export_excel = "{{ route('rekeningkoran.export-excel') }}?" + params;
                        //alert(export_excel);
